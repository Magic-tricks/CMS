<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/admin/lst.htm";i:1556887554;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($adminRes) || $adminRes instanceof \think\Collection || $adminRes instanceof \think\Paginator): $i = 0; $__LIST__ = $adminRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center"><?php echo date("Y-m-d H:i",$admin['create_time']); ?></td>
                                <td align="center"><?php echo date("Y-m-d H:i",$admin['last_time']); ?></td>
                                <td align="center">
                                    <label>
                                        <input id="<?php echo $admin['id']; ?>" status="<?php echo $admin['status']; ?>" onclick="changeStatus(this)" <?php if($admin['id'] == 1): ?> disabled="disabled" <?php endif; if($admin['status'] == 1): ?>checked="checked" <?php endif; ?> class="checkbox-slider colored-orange" type="checkbox">
                                        <span class="text" style="cursor: pointer;"></span>
                                    </label>
                                </td>
                                <td align="center"><?php echo $admin['title']; ?></td>
                                <td align="center" width="20%">
                                    <a href="<?php echo url('edit',['id'=>$admin['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',['id'=>$admin['id']]); ?>')" class="btn btn-danger btn-sm shiny">
