<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"../template/default/list_artiel.htm";i:1555249502;s:55:"/Applications/MAMP/htdocs/cms/template/default/head.htm";i:1555426587;s:57:"/Applications/MAMP/htdocs/cms/template/default/footer.htm";i:1556717071;}*/ ?>
<!DOCTYPE html>
<head id="Head">
...
<div class="entry-list entry-list-article entry-list-mobile">
 ...
 <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
    ...
    <div class="typo">
    <div class="typo-img">
    <div class="entry-img"><a href="http://www.chuanke.com/s2260700.html" target="_blank"><img src="/cms/public/static/index/uploads/img/<?php echo $art['litpic']; ?>" width="220" alt="中试车间数据指标达到国际先进水平"/></a></div>
    </div>
    ...
    <p> <?php echo cut_str($art['description'],140)?></p>
    </div>
    </div>
    </div>
     </div>
