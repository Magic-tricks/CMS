<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/Applications/MAMP/htdocs/cms/public/../application/install/view/index/step2.htm";i:1556368917;}*/ ?>
﻿<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<script type="text/javascript" src="/cms/public/static/install/style/jquery.validation.min.js"></script>
<script type="text/javascript" src="/cms/public/static/install/style/jquery.icheck.min.js"></script>
<script>
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库服务器</label>
          <span>
          <input type="text" name="db[hostname]" maxlength="60" value="localhost">
          </span> <em>数据库服务器地址，一般为localhost</em></div>
        <div>
          <label>数据库类型</label>
          <span>
          <input type="text" name="db[type]" maxlength="50" value="mysql">
          </span> <em></em></div>
        <div>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db[database]" maxlength="50" value="">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
          <input type="text" name="db[username]" maxlength="30" value="">
          </span> <em></em></div>
        <div>
          <label>数据库密码</label>
          <span>
          <input type="password" name="db[password]" maxlength="30" value="">
          </span> <em></em></div>
        <div>
          <label>数据库表前缀</label>
          <span>
          <input type="text" name="db[prefix]" maxlength="30" value="tp_">
          </span> <em>同一数据库运行多个多用户商城程序时，请修改前缀</em></div>
        <div>
          <label>数据库端口</label>
          <span>
          <input type="text" name="db[hostport]" maxlength="30" value="3306">
          </span> <em>数据库默认端口一般为3306</em></div>
                <div>
          <label>&nbsp;</label>
          <input  type="checkbox" id="demo_data" value="1" checked checked>
      ...
      <fieldset>
        ...
        <div>
          <label>站点名称</label>
          <span>
          <input name="admin[site_name]" value="" maxlength="100" type="text">
          </span> <em>输入站点名称，安装后可在平台设置中进行修改</em></div>
        <div>
          <label>管理员帐号</label>
          <span>
          <input name="admin[admin]" value="" maxlength="20" type="text">
          </span> <em></em></div>
        <div>
          <label>管理员密码</label>
          <span>
          <input name="admin[password]" id="password" maxlength="20" value="" type="password">
          </span> <em>管理员密码不少于6个字符</em></div>
        <div>
          <label>重复密码</label>
          <span>
          <input name="admin[rpassword]" value="" maxlength="20" type="password">
          </span> <em>确保两次输入的密码一致</em></div>
      </fieldset>
    </div>
    <div class="btn-box"><a href="./step1.htm" class="btn btn-primary">上一步</a>
      <a id="next" href="javascript:;" class="btn btn-primary">下一步</a></div>
  </form>
</div>
<div class="footer">
