<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/content/add_select.htm";i:1553527439;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" enctype="multipart/form-data" role="form" action="<?php echo url('Content/add'); ?>" method="get">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cate_id" style="width: 140px">
                                    ...
                                    <option value="<?php echo $cateRes['id']; ?>"><?php echo str_repeat('-',$cateRes['level']*6); ?><?php echo $cateRes['cate_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
...
//获取model_id和cate_id
    $("select[name='cate_id']").change(function () {
        ...
        $.ajax({
            ...
            dataType:   'json',
            data    :   {cateId:cate_id},
            url     :   "<?php echo url('Content/ajaxGetModelId'); ?>",
