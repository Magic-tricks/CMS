<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/content/lst.htm";i:1553355239;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
    ...
    <!-- /Sidebar Menu -->
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    ...
                    <?php if($modelId != 0):?>
<button type="button" tooltip="添加配置" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('add',['model_id'=>$modelId,'cate_id'=>$cateId]); ?>'"> <i class="fa fa-plus"></i> Add
</button>
                    <?php endif;?>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($artResult) || $artResult instanceof \think\Collection || $artResult instanceof \think\Paginator): $i = 0; $__LIST__ = $artResult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$artRes): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td align="center"><?php echo $artRes['id']; ?></td>
                                <td align="center"><?php echo $artRes['title']; ?></td>
                                <td align="center">
                                <?php if($artRes['attr'] != ''): $attrArr    =   explode(',',$artRes['attr']);
                                        foreach ($attrArr as $v)
                                        {
                                            echo "<span style='margin-left:5px;' class='label label-yellow'>".$v.'</span>';
                                        }
                                    else: ?>
                                    <span class='label label-red'>暂无属性</span>
                                    <?php endif; ?>
                                </td>
                                <td align="center"><?php echo $artRes['cate_name']; ?></td>
                                <td align="center"><?php echo $artRes['model_name']; ?></td>
                                <td align="center" width="20%">
                                    <a href="<?php echo url('edit',['art_id'=>$artRes['id'],'model_id'=>$artRes['model_id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',['id'=>$artRes['id']]); ?>')" class="btn btn-danger btn-sm shiny">
