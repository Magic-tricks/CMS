<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:32:"../template/default/list_pro.htm";i:1555252753;s:55:"/Applications/MAMP/htdocs/cms/template/default/head.htm";i:1555426587;s:57:"/Applications/MAMP/htdocs/cms/template/default/footer.htm";i:1556717071;}*/ ?>
<!DOCTYPE html>
<head id="Head">
...
<div>
<input type="hidden" name="__VIEWSTATE_CACHEKEY" id="__VIEWSTATE_CACHEKEY" value="VS_lhga4okip3d2oqe51ap3pijf_/p_01/language_zh-CN"/>
</div>
...
<div id="a1portalSkin_headerAreaA" class="header"> <a name="31459" id="31459"></a>
...
<div class="carousel-img"><a href="javascript:;" target=""><img src="<?php echo $temp_static; ?>/img/f420419c-885b-48fb-9209-d770c043d44b_0_350.jpg" height="350" alt=""/></a></div>
</div>
</div>
...
<div id="a1portalSkin_mainArea" class="content-wrapper"> <a name="31461" id="31461"></a>
<div class="module-default">
<div class="module-inner">
...
<ul class="column clearfix">
    ...
    <?php if(is_array($artRes) || $artRes instanceof \think\Collection || $artRes instanceof \think\Paginator): $i = 0; $__LIST__ = $artRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
        ...
        <div class="portfolio-img"><a href="<?php echo url('Article/index',['aid'=>$art['id']]); ?>" target="_blank"><img src="/cms/public/static/index/uploads/img/<?php echo $art['litpic']; ?>" alt="<?php echo cut_str($art['title'],30)?>"/></a></div>
        <div class="portfolio-title">
        <h2><a href="<?php echo url('Article/index',['aid'=>$art['id']]); ?>" target="_blank"><?php echo cut_str($art['title'],30)?></a></h2>
        </div>
        </div>
        </li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
