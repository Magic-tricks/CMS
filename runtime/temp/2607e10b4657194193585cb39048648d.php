<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/admin/edit.htm";i:1553094319;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="group_id">
                                    <option>请选择</option>
                                    <?php if(is_array($groupRes) || $groupRes instanceof \think\Collection || $groupRes instanceof \think\Paginator): $i = 0; $__LIST__ = $groupRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?>
                                    <option <?php if($group['id'] == $admin['group_id']): ?> selected="selected" <?php endif; ?> value="<?php echo $group['id']; ?>"><?php echo $group['title']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $admin['uname']; ?>" placeholder="" name="uname" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="留空则不修改" name="password"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
