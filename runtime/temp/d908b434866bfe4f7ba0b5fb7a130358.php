<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/auth_group/lst.htm";i:1556887554;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($authGroupRes) || $authGroupRes instanceof \think\Collection || $authGroupRes instanceof \think\Paginator): $i = 0; $__LIST__ = $authGroupRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$authGroup): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center">
                                    <label>
                                        <input <?php if($authGroup['status'] == 1): ?> checked="checked" <?php endif; ?> id="<?php echo $authGroup['id']; ?>"  onclick="changeStatus(this)" class="checkbox-slider colored-orange" type="checkbox">
                                        <span class="text" style="cursor: pointer;"></span>
                                    </label>
                                </td>
                                <td align="center" width="20%">
                                    <a href="<?php echo url('power'   ,['id'=>$authGroup['id']]); ?>" class="btn btn-warning btn-sm shiny">
                                        <i class="fa fa-key"></i> 权限
                                    </a>
                                    <a href="<?php echo url('edit'   ,['id'=>$authGroup['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',['id'=>$authGroup['id']]); ?>')" class="btn btn-danger btn-sm shiny">
