<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/conf/lst.htm";i:1537923996;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
                        ...
                        <?php if(is_array($confRes) || $confRes instanceof \think\Collection || $confRes instanceof \think\Paginator): $i = 0; $__LIST__ = $confRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center" width="20%">
                                    <a href="<?php echo url('Conf/edit',['id'=>$conf['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('Conf/del',['id'=>$conf['id']]); ?>')" class="btn btn-danger btn-sm shiny">
