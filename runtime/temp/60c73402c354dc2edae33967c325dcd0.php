<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/model/lst.htm";i:1556887554;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($modelRes) || $modelRes instanceof \think\Collection || $modelRes instanceof \think\Paginator): $i = 0; $__LIST__ = $modelRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$model): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center"><a href="<?php echo url('ModelFields/lst',['modelId'=>$model['id']]); ?>"><?php echo $model['model_name']; ?></a> </td>

                                <td align="center"><?php echo $prefix; ?><?php echo $model['table_name']; ?></td>
                                <td align="center"><a href="javascript:;" onclick="ajaxUpdate(this)" modelid="<?php echo $model['id']; ?>"  <?php if($model['status'] == 1): ?>class="btn-primary btn-sm shiny" <?php else: ?>class="btn btn-danger btn-sm shiny"<?php endif; ?>><?php if($model['status'] == 1): ?>启用 <?php else: ?> 禁用<?php endif; ?></a> </td>
                                <td align="center" width="30%">
                                    <a href="<?php echo url('ModelFields/lst',['modelId'=>$model['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-list-ul"></i> 字段列表
                                    </a>
                                    <a href="<?php echo url('edit',['modelId'=>$model['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" table_name="<?php echo $prefix; ?><?php echo $model['table_name']; ?>" id="<?php echo $model['id']; ?>" onclick="ajaxdel(this)" class="btn btn-danger btn-sm shiny">
...
<script>
    ...
    function ajaxdel(o){
        layer.confirm('确认要删除该模型吗?', {icon: 3, title: '提示'}, function (index) {
            ...
            $.ajax({
                url: "<?php echo url('Model/ajaxdel'); ?>",
                type: "POST",
                data: {
                    'id':id,
