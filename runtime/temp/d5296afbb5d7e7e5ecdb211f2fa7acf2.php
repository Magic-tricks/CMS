<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/Applications/MAMP/htdocs/cms/public/../application/admin/view/model/add.htm";i:1547645279;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/head.htm";i:1552488777;s:68:"/Applications/MAMP/htdocs/cms/application/admin/view/common/left.htm";i:1553525442;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>叶子空间</title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('lst'); ?>">模型管理</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">模型名称</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="model_name" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">模型表名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="table_name" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div style="float: left;" class="radio"><label>
                                    <input value="1"  checked="checked" name="status" type="radio">
                                    <span class="text">启用</span>
                                </label>
                                </div>
                                <div style="float: left;margin-left: 10px" class="radio">
                                    <label>
                                        <input value="0"  class="inverted" name="status" type="radio">
